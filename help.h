...
static struct argp_option options[] =
{
    ...
    {"write-temp-heatmap", OptTempHeatmap, "<interval in seconds>", 0, "write heatmap to json dir, don't use with globe-history-heamap", 1},
    ...
    {"json-reliable", OptJsonReliable,"<n>", 0, "Minimum position reliability to put it into json (default: 2)", 1},
#endif
