...
static struct argp_option optionsReadsb[] = {
    ...
    {"preamble-threshold", OptPreambleThreshold, "<40-100>", 0, "lower threshold --> more CPU usage (default: "stringize(PREAMBLE_THRESHOLD_DEFAULT)", pi zero / pi 1: "stringize(PREAMBLE_THRESHOLD_PIZERO)", hot CPU "stringize(PREAMBLE_THRESHOLD_HOT)")", 1},
